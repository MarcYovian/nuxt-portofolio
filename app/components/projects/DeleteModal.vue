...
async function onDelete() {
    ...
    try {
        ...
        toast.add({
            title: 'Error',
            description: error.data?.message || error.message || 'Failed to delete projects',
            color: 'error',
...
<template>
    <UModal v-model:open="open" title="Delete projects"
        description="Are you sure you want to delete these projects? This action cannot be undone.">
        <template #body>
            <div class="space-y-4">
